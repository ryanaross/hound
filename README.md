...
[![Build Status](https://travis-ci.org/ryanaross/yaml-hound.svg?branch=master)](https://travis-ci.org/ryanaross/yaml-hound) 
...
```
go get github.com/ryanaross/yaml-hound/cmds/...
```
...
```
git clone https://github.com/ryanaross/yaml-hound.git ${GOPATH}/src/github.com/ryanaross/yaml-hound
cd ${GOPATH}/src/github.com/ryanaross/yaml-hound
make
```

If this is your only Go project, you can set your GOPATH just for Hound:
```
git clone https://github.com/ryanaross/yaml-hound.git src/github.com/ryanaross/yaml-hound
GOPATH=$(pwd) make -C src/github.com/ryanaross/yaml-hound
```
